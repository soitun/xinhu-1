...
class modeClassModel extends Model
{
	...
	//判断模块是否开启存在
	public function iscun($num, $owhe='')
	{
		$to = $this->rows("`num`='$num' and `status`=1 $owhe");
		return $to==1;
	}
...
".$hendts."";
	...
	*/
	...
	public function menulist()
	{
		...
		$arr['crm'] 		= '63,37,64,73,104,105,114,118,126,179,262,299,131,132,75,112,113,123,263,317,110,111,108,109,106,119,115,116,117,107,120,121,122,175,176,177,178,264,302,318,300,301,386,387,458,459,460,466,467,468,462,461,473,474';
		...
		$arr['wyxiaoqu']	= '438,439,440,441,442,443,444,445,446,447,448,449,450,451,469,470,475,481,476,482,477,478,479,480';
		return $arr;
	}
